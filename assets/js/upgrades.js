...
function getUpgradeAttack(upgrade, side){
    if (upgrade.sides[side].hasOwnProperty('attack')){
        ...
        if (upgrade.sides[side].attack.ordnance){
            ...
            $('#pilot_attack').append('<div class="upgrade_stat"><span class="upgrade_stat_icon">'+arc+'</span><span class="upgrade_stat_value">'+value+'</span><br><span class="attack_range">'+'('+minRange + ' - ' + maxRange + ')</span></div>');
            return '';
        }
